...
API extends RestEndpoint,
ENDPOINTS extends ReadonlyArray<StubEndpoint<API>>,
> (endpoints: ENDPOINTS) =>
    <REQUEST extends RestEndpointRequest> (request: REQUEST):
    Observable<GetResponseType<API, REQUEST>> => {
      const endpoint = endpoints
        .find((endpoint: StubEndpoint<RestEndpoint>): endpoint is StubEndpoint<RestEndpoint<REQUEST>> =>
